...
<div class="so-dashboard">
	...
	<div class="so-flex">
		<div class="so-board">
			...
			<div class="board-field right">
				...
				<div class="note">CAPTCHA statistic last 7 days.</div>
			</div>
		</div>
		<div class="so-board">
			<div class="board-field left">
			...
			<div class="board-field right">
				...
				<div class="note">Total pageviews last 7 days.</div>
			</div>
		</div>
	...
	<div class="so-tabs">
		<ul>
			...
			<li class="is-active"><a href="<?php echo $page_url; ?>&tab=past_seven_days">Last 7 days</a></li>
