...
<div class="so-dashboard">
    ...
    <div class="so-flex">
        <div class="so-board">
            ...
            <div class="board-field right">
                ...
                <div class="note">CAPTCHA statistic this month.</div>
            </div>
        </div>
        <div class="so-board">
            <div class="board-field left">
            ...
            <div class="board-field right">
                ...
                <div class="note">Total pageviews this month.</div>
            </div>
        </div>
    ...
    <div class="so-tabs">
        <ul>
            ...
            <li class="is-active"><a href="<?php echo $page_url; ?>&tab=this_month">This month</a></li>
